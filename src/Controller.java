...
public class Controller implements ActionListener {
    private final String materialNameToConvert;
    ...
    public Controller(JButton material,JTextField input, JComboBox comboBoxMaterials){
        ...
        comboBoxMaterials.addActionListener(e-> currentMaterial=Materials.values()[comboBoxMaterials.getSelectedIndex()]);
    ...
    public void actionPerformed(ActionEvent e) {
        double currentInput = Double.parseDouble(input.getText());
